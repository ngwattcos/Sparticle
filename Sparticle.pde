...
class Rocket extends PhysicsObj {
  ...
  void interact() {
    ...
    // drag
    Vector force_drag = velocity.copy().mult(-0.01 * velocity.mag);
    //force_drag.divide(force_drag.mag);
    //force_drag.mult(0.5 * velocity.mag * velocity.mag);
    //force_drag.mult(1);
    //applyForce(force_drag, new Vector(0, 0));
